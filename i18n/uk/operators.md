...
- **Керування може бути даними, а не панеллю.** Коли вам потрібен такий контроль, керуйте каталогом інструментів як Git-репозиторієм — рецензування pull-request стає затвердженням бренду, з повним журналом аудиту та миттєвим відкатом кожного шаблону, до якого має доступ ваш персонал. Це варіант, а не обов'язок: команди, які просто хочуть щось створювати, авторують власні інструменти в Design та завантажують власні файли в каталог повністю в застосунку й ніколи не торкаються git. Див. [Впровадження та керування](/info/adoption-governance.html).
