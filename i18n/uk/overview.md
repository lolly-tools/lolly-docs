...
- **Людина, у застосунку.** Пакетна сітка `/pro`: вставте або імпортуйте рядки, отримайте по одному готовому ресурсу на рядок, завантажте zip. Без дизайнерських навичок, без тікета, без очікування.
- **Розробник, з командного рядка.** CLI запускає *той самий* рушій і *той самий* шлях рендерингу без інтерфейсу, тож інструмент можна прогнати по всіх 10 000 рядках у скрипті або нічному конвеєрі. Виклик `lolly <tool> --field=…` у циклі — це вся інтеграція.
- **Система або AI-агент, через MCP.** Той самий інструмент, керований програмно, з тією самою якістю й у ще більшому масштабі — бо машині не стане нудно, поки надходять тисячі файлів.
