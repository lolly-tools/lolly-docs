...
یہی وہ واحد دروازہ اندر ہے، اسی لیے آپ کے برانڈ میں کچھ بھی بغیر دیکھے نہیں آتا۔ اسٹیج کے نیچے دو مینجمنٹ پینلز ہیں:
...
ریل کے نچلے حصے میں **Versions** وہ جگہ ہے جہاں ڈیزائن سسٹم ایک متحرک ہدف بننا چھوڑ دیتا ہے۔ ایک ورژن شائع کریں تو آپ کو اس ڈیوائس پر رکھی گئی ایک **مستقل، نام والی کاپی** ملتی ہے: یہ بعد میں کبھی نہیں بدلتی، اس لیے جو ٹول اسے پن کرتا ہے وہ ہمیشہ وہی چیز بناتا رہتا ہے۔ پینل اُس وقت تک چھپا رہتا ہے جب تک شائع کرنے کے لیے آپ کی اپنی کوئی چیز موجود نہ ہو، اس لیے جو اسٹوڈیو کبھی شائع نہیں کرتا اسے یہ مشینری کبھی نہیں دکھائی جاتی۔

کچھ بھی دبانے سے پہلے جاننے کی تین باتیں، اور پینل یہ تینوں باتیں دبانے سے پہلے بتاتا ہے، بعد میں نہیں:

- **A version is permanent.** ابھی حذف کرنے کا کوئی آپشن نہیں، اس لیے پینل واضح کرتا ہے کہ کیا محفوظ کیا گیا ہے اور یہ کہ وہ محفوظ ہی رہے گا، بجائے اس کے کہ ایک ایسا بٹن پیش کرے جو جھوٹ بولے۔
- **Removals lead the compatibility card.** شامل اور تبدیل شدہ ٹوکنز خبر ہیں؛ ایک *ہٹایا گیا* ٹوکن وہ چیز ہے جو کسی ٹول کو توڑ دیتی ہے، اس لیے اسے سب سے پہلے نام دے کر بتایا جاتا ہے کہ یہ کیا ہے۔
- **Publishing can't be undone; restoring can.** *Restore latest from this version* ہیڈ میں کی گئی ایک عام ترمیم ہے، اس لیے یہ اسٹوڈیو کے undo اسٹیک پر آ جاتی ہے اور پینل فوراً آپ کو **Undo** کا آپشن دیتا ہے۔
