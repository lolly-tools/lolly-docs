...
popisem toho, co kód dělá dnes, je to hranice, kterou prohlížeč aplikaci vynucuje: budoucí
změna, která by se pokusila kontaktovat nějakého jiného hostitele, by byla zablokována,
ne tiše povolena. Dva řádky nemají pevného hostitele, protože si adresu volíš v okamžiku
použití: URL, kterou požádáš nástroj zachytit, a vzdálená instance, na kterou shell nasměruješ.
Žádný z nich není v zásadách a oba nastanou jen tehdy, když adresu zadáš a jednáš podle ní.
Nasazení, které nechce žádnou z volitelných věcí (řekněme firemní instance s vlastními fonty),
tyto hostitele ze svých zásad odstraní a funkce selžou uzavřeně místo aby se ozvaly ven.
