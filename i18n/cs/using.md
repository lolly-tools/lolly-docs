...
![Celá editační plocha: kresebná plocha, lišta nástrojů a časová osa pohromadě](/t/url-shot?url=%2F%23%2Ftool%2Fdesign%3Fz%3D11dZBb5swFADgX8MOiRYZB0J76GFpNO2wnbr7ZMwDrBg7s01C8usngmNwSqJszaT2aD8_G54_PUgJXRdK1iJ7CvAcpSHG6FMqG9BPQbwMkmWAMcsCjIP5lwDjUsp1O8DPAcZrJvpIKhsXaLpZ1I323mjXjcJHbCdKO4Ee7ISSxsvQJdmAO0cBNe6gtHDzQbKkkks101ARYRidaaBSZETtg2TlMgw0xuX8LBXANCN7PTVyWki3Kr-6b61yQmG4ay6FeWEHOL1K1E0TzgrhdqIgDCiXs_WjFcsyDi66A1aU_ZMuEPIOcwFNhHYRzgR8GySGs9CW0BDlFzWrVTe2qdCwftOcZP2TtJEfuovFyKZzIvor0fD7WKhVGzsXo2ALhH8UMxvFqmtiXmQFpmSimArYBfGzYHpKZcVEcS87-OHedpK72cHndmYWunu6rtxM-3wuwGqTXskacov-nhs15KNYG7HgWZtMvpNa0LJtUJNJi-2rYhnZ3ybtuNUVZuj9MotOrAbQFmPQbuB0uxwud4NX9-ycrmWIJw59Pg9h5AF6RGd-5vgWPhvG-2b5xs8bl5zvZ0ZK3tf_bd0pxu_lw2YDG2Jv6VRdj9Hi__WrKB7pV3OELuBKIRunReqM9f8d1tbnKPFsJVHs2Zqf9SaMLrSmASCjiNAbokD0lD0t_95Wxu-MVaQ4uT6WQ8ta0V46Z6lq9br1fVEOh7ypju-FFyjBC7fmVy0UaMm3YBcbVYMt-dhfTlUbe2BOuD6ujFd_AA&width=1440&height=900&dpi=192&waitMs=7000&waitSelector=.tl-clip&css=.fc-toolbar%7Bopacity%3A1!important%7D&format=svg&walker=1&tolerance=0.03&dark=1&filename=seq-studio-stage)
...
- **Jestli v něm bude tvoje jméno.** Tvoje jméno, e-mail a organizace se do souboru zapíšou, jen když máš v profilu zapnuté **Použít moje údaje k tvorbě**. S vypnutým nastavením si soubor pamatuje jen to, že vznikl v Lolly a kdy - nic o tobě.
- **Jestli v něm bude licencovaná grafika.** Licencované assety a assety zamčené značkou se ve výchozím stavu nepřikládají. Pokud je návrh používá, dialog řekne kolik a nabídne dvě tlačítka - *Stáhnout bez nich*, nebo *Přiložit a stáhnout* - protože jejich přiložením předáváš skutečné soubory každému, kdo `.lolly` otevře.
- **Jestli v něm bude nástroj.** **Přiložit nástroj** zabalí vedle návrhu i soubory samotného nástroje, takže se otevře i na zařízení, které ten nástroj nemá. U vlastního nástroje přichází zaškrtnuté - u forku nebo privátního nástroje značky, který příjemce nejspíš nemá - a nezaškrtnuté u nástroje, který se bajt po bajtu shoduje s podepsaným katalogem, protože jeho kopie je už stejný soubor.
...
- <!--i:upload--> **Přines si svoje soubory.** Přetáhni jakýkoli obrázek, SVG, zvukový klip, video, Lottie, PDF nebo prezentaci z PowerPointu na oblast pro nahrávání - nebo klikni a vyber - a okamžitě přistane v tvém katalogu, připravený ve výběru assetů každého nástroje. U vícestránkového PDF nebo `.pptx` se aplikace zeptá, které stránky nebo snímky ponechat - z každého bude asset SVG. Nahraj si, kolik chceš; nikdy to neopustí tvoje zařízení.
- <!--i:star--> **Označ si oblíbené to, po čem saháš.** Dej assetu (nebo vzorku značky) ★ a připne se na začátek každého výběru, takže tvoje oblíbené logo nebo barva je na jedno kliknutí.
- <!--i:folder--> **Ukliď si.** Přeřaď asset do jiné skupiny, skryj sdílený asset značky, který nepoužíváš (a **Zobrazit skryté** ho vrátí zpátky), nebo úplně smaž své vlastní nahrané soubory. Stejné gesto vícenásobného výběru a stejná plovoucí lišta akcí jako v Projektech fungují i tady, takže cokoli z toho jde udělat s celým výběrem najednou.
