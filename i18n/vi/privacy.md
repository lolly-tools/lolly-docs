...
mô tả về những gì mã nguồn làm hôm nay, đó là ranh giới mà trình duyệt buộc ứng dụng
tuân theo: một thay đổi trong tương lai cố gắng liên hệ với máy chủ khác sẽ bị chặn,
không được âm thầm cho phép. Hai dòng không có máy chủ cố định, vì bạn chọn
địa chỉ ngay tại thời điểm sử dụng: một URL bạn yêu cầu một công cụ chụp, và một thực thể
từ xa bạn trỏ lớp vỏ tới. Không dòng nào nằm trong chính sách, và mỗi trường hợp chỉ xảy ra
khi bạn gõ một địa chỉ và thực hiện thao tác trên đó. Một bản triển khai không muốn bất kỳ tùy chọn nào
(chẳng hạn một thực thể doanh nghiệp với phông chữ riêng) loại bỏ các máy chủ đó
khỏi chính sách của mình và các tính năng sẽ thất bại theo hướng đóng thay vì kết nối ra ngoài.
