...
**Một catalog thương hiệu (brand catalog) được tuyển chọn cẩn thận phải được biên soạn.** Lolly là một nền tảng (platform), không phải một bộ template đã hoàn thiện sẵn cho bạn. Đối với một *lần triển khai có kiểm soát (governed rollout)*, ai đó cần định nghĩa asset catalog dùng chung (logo, bảng màu, font chữ dưới dạng ID vĩnh viễn) và viết manifest + template cho từng loại đầu ra. Dù vậy, các cá nhân không cần phải chờ điều đó - trong ứng dụng mở, bất kỳ ai cũng có thể đưa file của riêng mình vào catalog và xây dựng tool trong Design ngay từ ngày đầu tiên.

**Quản trị bằng git (governance-by-git) là tùy chọn - và xa lạ với những người không làm kỹ thuật.** Nếu bạn vận hành một catalog *dùng chung và có kiểm soát*, thì "việc review PR *chính là* việc kiểm duyệt (moderation)" là một cách nói thanh lịch đối với kỹ sư nhưng lại xa lạ với hầu hết các đội brand và marketing. Nếu những người sở hữu quyết định về thương hiệu không sống trong git, bạn sẽ cần một quy trình làm cầu nối cho họ - nếu không, IT sẽ âm thầm trở thành đối tác thiết kế chiến lược và người gác cổng (gatekeeper) của cả tổ chức (một vai trò được nhiều người ưa chuộng trong các môi trường sản xuất vận hành lâu dài). Những đội không muốn điều này thì đơn giản là bỏ qua nó.

**Nó cố tình hẹp phạm vi - hãy nhìn nhận nó theo cách đó.** Lolly không dành cho nội dung tùy biến riêng lẻ (bespoke) hay nội dung "hero". Nó *là* DAM cá nhân của bạn - được nạp dữ liệu và tăng cường sức mạnh bởi design system, tools và catalog của bạn - và nó *có* một canvas mở (Design), nhưng ngay cả ở đó, màu sắc, kiểu chữ và asset vẫn tuân theo các thiết lập thiết kế toàn cục (design globals) đang hoạt động, vì vậy việc sắp xếp tự do vẫn nằm trong hệ thống. So với Figma hay Canva, nó sẽ trông có vẻ hạn chế. Nhưng nhìn nhận đúng bản chất của nó - việc tạo asset ở quy mô vận hành hóa, lặp lại, quy mô lớn - thì không gì sánh được. Khung nhìn sai lệch là trở ngại phổ biến nhất.
...
Có. Mở **Design** và nhấp vào **Import a design**: nó chấp nhận file Figma gốc **.fig** (Save local copy), file xuất ra từ Penpot **.penpot**, file Illustrator **.ai** hoặc **.pdf**, file InDesign **.idml** (File → Export → InDesign Markup), hoặc **bất kỳ file SVG** nào (cánh cửa rộng - hầu như ứng dụng thiết kế nào cũng xuất được SVG). Mọi thứ được phân tích (parse) hoàn toàn trên thiết bị của bạn, không cần tài khoản hay plugin nào.
