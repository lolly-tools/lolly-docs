...
> Mới đến đây? [Bắt đầu](/info/getting-started.html) sẽ hướng dẫn cài đặt/triển khai ứng dụng; trang này nói về cách sử dụng nó khi đã mở.
...
Cạnh công tắc đó là **Neurospicy Mode** — một nhịp nền tập trung, êm dịu, tuỳ chọn, lặp lại nhẹ nhàng trong lúc bạn làm việc. Chọn một vòng lặp từ bộ chọn dạng viên thuốc, phát hoặc tạm dừng bằng nút bên cạnh, và chỉnh âm lượng của nó; tính năng này **tắt theo mặc định** và, giống như Sound, được ghi nhớ qua các phiên làm việc và các thiết bị. Tắt Sound cũng sẽ tắt tiếng nhịp tập trung này.
