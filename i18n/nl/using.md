...
![Het hele bewerkingsoppervlak: tekenvlak, gereedschapsbalk en tijdlijn bij elkaar](/t/url-shot?url=%2F%23%2Ftool%2Fdesign%3Fz%3D11dZBb5swFADgX8MOiRYZB0J76GFpNO2wnbr7ZMwDrBg7s01C8usngmNwSqJszaT2aD8_G54_PUgJXRdK1iJ7CvAcpSHG6FMqG9BPQbwMkmWAMcsCjIP5lwDjUsp1O8DPAcZrJvpIKhsXaLpZ1I323mjXjcJHbCdKO4Ee7ISSxsvQJdmAO0cBNe6gtHDzQbKkkks101ARYRidaaBSZETtg2TlMgw0xuX8LBXANCN7PTVyWki3Kr-6b61yQmG4ay6FeWEHOL1K1E0TzgrhdqIgDCiXs_WjFcsyDi66A1aU_ZMuEPIOcwFNhHYRzgR8GySGs9CW0BDlFzWrVTe2qdCwftOcZP2TtJEfuovFyKZzIvor0fD7WKhVGzsXo2ALhH8UMxvFqmtiXmQFpmSimArYBfGzYHpKZcVEcS87-OHedpK72cHndmYWunu6rtxM-3wuwGqTXskacov-nhs15KNYG7HgWZtMvpNa0LJtUJNJi-2rYhnZ3ybtuNUVZuj9MotOrAbQFmPQbuB0uxwud4NX9-ycrmWIJw59Pg9h5AF6RGd-5vgWPhvG-2b5xs8bl5zvZ0ZK3tf_bd0pxu_lw2YDG2Jv6VRdj9Hi__WrKB7pV3OELuBKIRunReqM9f8d1tbnKPFsJVHs2Zqf9SaMLrSmASCjiNAbokD0lD0t_95Wxu-MVaQ4uT6WQ8ta0V46Z6lq9br1fVEOh7ypju-FFyjBC7fmVy0UaMm3YBcbVYMt-dhfTlUbe2BOuD6ujFd_AA&width=1440&height=900&dpi=192&waitMs=7000&waitSelector=.tl-clip&css=.fc-toolbar%7Bopacity%3A1!important%7D&format=svg&walker=1&tolerance=0.03&dark=1&filename=seq-studio-stage)
...
- **Of je naam meegaat.** Je naam, e-mailadres en organisatie worden alleen in het bestand geschreven wanneer **Gebruik mijn gegevens om te maken** aan staat in je profiel. Staat het uit, dan legt het bestand vast dat het met Lolly is gemaakt en wanneer - niets over jou.
- **Of gelicentieerde beelden meegaan.** Gelicentieerde en merkvergrendelde assets blijven standaard achter. Gebruikt het ontwerp er een paar, dan zegt de dialoog hoeveel en biedt hij twee knoppen - *Zonder ze downloaden* of *Insluiten en downloaden* - want ze insluiten geeft de daadwerkelijke bestanden aan iedereen die de `.lolly` opent.
- **Of de tool meegaat.** **De tool insluiten** pakt de eigen bestanden van de tool naast het ontwerp in, zodat het opent op een apparaat dat die tool niet heeft. Het staat aangevinkt bij een eigen tool - een fork of een privé merktool die je ontvanger waarschijnlijk niet heeft - en uitgevinkt bij een tool die byte voor byte overeenkomt met de ondertekende catalogus, want hun kopie is al hetzelfde bestand.
...
- <!--i:upload--> **Breng je bestanden binnen.** Sleep een willekeurige afbeelding, SVG, audiofragment, video, Lottie, PDF of PowerPoint-presentatie naar het uploadgebied - of klik om te kiezen - en het belandt direct in je catalogus, klaar in de assetkiezer van elke tool. Bij een PDF met meerdere pagina's of een `.pptx` wordt gevraagd welke pagina's of dia's je wilt houden - elk daarvan wordt een SVG-asset. Haal binnen zoveel je wilt; het verlaat je apparaat nooit.
- <!--i:star--> **Markeer als favoriet wat je vaak pakt.** Geef een asset (of een merkstaal) een ★ en het wordt bovenaan elke kiezer vastgezet, zodat je vaste logo of kleur één klik verwijderd is.
- <!--i:folder--> **Ruim op.** Hercategoriseer een asset naar een andere groep, verberg een gedeeld merkasset dat je niet gebruikt (met **Verborgen tonen** om het terug te halen) of verwijder je eigen uploads definitief. Hetzelfde meervoudige-selectiegebaar en dezelfde zwevende actiebalk als in Projecten werken hier ook, dus dat alles kan in één keer op een hele selectie.
