...
![La vue divisée d'un outil - la pile de contrôles à gauche, et l'histogramme groupé en direct qu'il dessine à droite](/t/url-shot?url=%2F%23%2Ftool%2Fd3%3Fct%3Dbar%26t%3DExample%2520data%26st%3DSample%2520values%252C%2520not%2520a%2520real%2520dataset%26d%3DMonth%252CSeries%2520A%252CSeries%2520B%252CSeries%2520C%250AJan%252C12%252C9%252C5%250AFeb%252C18%252C14%252C7%250AMar%252C24%252C17%252C11%250AApr%252C29%252C23%252C15%26lg%3D1&width=1440&height=900&dpi=192&waitMs=2500&walker=1&format=svg&dark=1&filename=vt-tool-split-view)
...
![Toute la surface d'édition : le plan de travail, la barre d'outils et la chronologie réunis](/t/url-shot?url=%2F%23%2Ftool%2Fdesign%3Fz%3D11dZBb5swFADgX8MOiRYZB0J76GFpNO2wnbr7ZMwDrBg7s01C8usngmNwSqJszaT2aD8_G54_PUgJXRdK1iJ7CvAcpSHG6FMqG9BPQbwMkmWAMcsCjIP5lwDjUsp1O8DPAcZrJvpIKhsXaLpZ1I323mjXjcJHbCdKO4Ee7ISSxsvQJdmAO0cBNe6gtHDzQbKkkks101ARYRidaaBSZETtg2TlMgw0xuX8LBXANCN7PTVyWki3Kr-6b61yQmG4ay6FeWEHOL1K1E0TzgrhdqIgDCiXs_WjFcsyDi66A1aU_ZMuEPIOcwFNhHYRzgR8GySGs9CW0BDlFzWrVTe2qdCwftOcZP2TtJEfuovFyKZzIvor0fD7WKhVGzsXo2ALhH8UMxvFqmtiXmQFpmSimArYBfGzYHpKZcVEcS87-OHedpK72cHndmYWunu6rtxM-3wuwGqTXskacov-nhs15KNYG7HgWZtMvpNa0LJtUJNJi-2rYhnZ3ybtuNUVZuj9MotOrAbQFmPQbuB0uxwud4NX9-ycrmWIJw59Pg9h5AF6RGd-5vgWPhvG-2b5xs8bl5zvZ0ZK3tf_bd0pxu_lw2YDG2Jv6VRdj9Hi__WrKB7pV3OELuBKIRunReqM9f8d1tbnKPFsJVHs2Zqf9SaMLrSmASCjiNAbokD0lD0t_95Wxu-MVaQ4uT6WQ8ta0V46Z6lq9br1fVEOh7ypju-FFyjBC7fmVy0UaMm3YBcbVYMt-dhfTlUbe2BOuD6ujFd_AA&width=1440&height=900&dpi=192&waitMs=7000&waitSelector=.tl-clip&css=.fc-toolbar%7Bopacity%3A1!important%7D&format=svg&walker=1&tolerance=0.03&dark=1&filename=seq-studio-stage)
...
**Au-delà des préréglages : images clés, profondeur et caméra.** Une transition anime un clip quand il arrive et quand il repart. Pour poser une boîte *à l'intérieur* d'un clip - la faire dériver, la faire disparaître en fondu, la flouter, la décoller de la page et la reposer - ajoute des images clés : sélectionne le clip, appuie sur **+Image clé** (le losange dans le groupe d'outils de la chronologie, le losange de la barre d'objet du canevas ou `K`) et la position de la tête de lecture décide quelle pose ta prochaine modification écrit. La même mécanique donne à chaque composition minutée une **caméra** qui avance, balaye et fait la mise au point, et transforme un SVG plat en une pile de calques entre lesquels tu peux voler. **[Animer](/info/animating.html)** est le guide complet.
...
Dans une [collaboration](/info/collaborate.html) en direct, l'historique reste le tien seul. Un changement qui arrive de l'autre appareil n'atterrit jamais sur ta pile, donc annuler ne peut reprendre que quelque chose que tu as fait.
...
![Deux cartes d'outils cochées dans la galerie Outils, avec la barre de sélection flottante qui affiche 2 selected et propose Available offline, View sessions, Favourite et Hide](/t/url-shot?url=%2F%23%2F&width=1440&height=900&dpi=192&waitMs=1600&css=.welcome-dialog%2C.personalize-nudge%7Bdisplay%3Anone!important%7D&drive=click%3A%5Bdata-select%3D%22qr-code%22%5D%3Bclick%3A%5Bdata-select%3D%22mesh-gradient%22%5D&waitSelector=.gallery-view%5Bdata-shots-settled%5D&walker=1&format=svg&dark=1&filename=misc-bulkbar-gallery)
<!--
...
- **Si ton nom y figure.** Ton nom, ton e-mail et ton organisation ne sont écrits dans le fichier que si **Utiliser mes informations pour créer** est activé dans ton profil. Sinon, le fichier note qu'il a été fait avec Lolly et quand - rien sur toi.
- **Si les visuels sous licence y figurent.** Les assets sous licence et verrouillés par la marque sont retenus par défaut. Si le design en utilise, la boîte de dialogue indique combien et propose deux boutons - *Télécharger sans eux* ou *Inclure et télécharger* - parce que les inclure remet les fichiers eux-mêmes à quiconque ouvre le `.lolly`.
- **Si l'outil y figure.** **Inclure l'outil** empaquette les fichiers de l'outil avec le design, pour qu'il s'ouvre sur un appareil qui n'a pas cet outil. Il arrive coché pour un outil personnalisé - un fork ou un outil de marque privé que ton destinataire a peu de chances d'avoir - et décoché pour un outil identique au catalogue signé octet pour octet, puisque leur copie est déjà le même fichier.

**En ouvrir un.** Dépose un `.lolly` sur l'application : les assets atterrissent dans ta bibliothèque, la session atterrit dans Projets et l'outil s'ouvre dessus. Rien de ce qui t'appartient n'est écrasé : la session arrive dans un nouvel emplacement enregistré, tandis qu'un asset déjà présent sur cet appareil est reconnu par somme de contrôle et réutilisé plutôt que dupliqué. Chaque partie est vérifiée face aux sommes de contrôle du fichier à l'entrée, si bien qu'une copie endommagée en transit est refusée plutôt qu'importée à moitié.
...
- <!--i:upload--> **Importe tes fichiers.** Fais glisser n'importe quelle image, SVG, clip audio, vidéo, Lottie, PDF ou présentation PowerPoint sur la zone d'import - ou clique pour choisir - et le fichier atterrit instantanément dans ton catalogue, prêt dans le sélecteur d'assets de chaque outil. Un PDF de plusieurs pages ou un `.pptx` te demande quelles pages ou diapositives garder - chacune devient un asset SVG. Importe autant que tu veux ; rien ne quitte ton appareil.
- <!--i:star--> **Mets en favori ce que tu utilises souvent.** Marque un asset (ou un échantillon de marque) d'une ★ et il s'épingle en haut de chaque sélecteur, si bien que ton logo ou ta couleur de prédilection est à un clic.
- <!--i:folder--> **Fais le ménage.** Recatégorise un asset dans un autre groupe, masque un asset de marque partagé que tu n'utilises pas (avec **Afficher les masqués** pour le faire revenir) ou supprime carrément tes propres imports. Le même geste de sélection multiple et la même barre d'action flottante que dans Projets fonctionnent ici aussi, tout cela peut donc se faire sur toute une sélection d'un coup.
...
Batch, c'est de nombreuses variantes d'*un seul* design. La **Multi-édition** est l'autre moitié du travail : plusieurs designs enregistrés **différents** ouverts en même temps, pour qu'une seule modification les touche tous. Coche entre **deux et huit** sessions enregistrées dans **Projets** et choisis **Modifier ensemble** dans la barre de sélection ; elles s'ouvrent en cartes vivantes côte à côte à `#/multi?s=<slot>,<slot>…`. Chaque carte est un vrai rendu de cette session, pas une vignette stockée, donc ce que tu vois est ce qu'elle exportera.
