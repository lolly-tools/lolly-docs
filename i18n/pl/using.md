...
![Widok dzielony narzędzia - stos kontrolek po lewej i rysowany na żywo grupowany wykres słupkowy po prawej](/t/url-shot?url=%2F%23%2Ftool%2Fd3%3Fct%3Dbar%26t%3DExample%2520data%26st%3DSample%2520values%252C%2520not%2520a%2520real%2520dataset%26d%3DMonth%252CSeries%2520A%252CSeries%2520B%252CSeries%2520C%250AJan%252C12%252C9%252C5%250AFeb%252C18%252C14%252C7%250AMar%252C24%252C17%252C11%250AApr%252C29%252C23%252C15%26lg%3D1&width=1440&height=900&dpi=192&waitMs=2500&walker=1&format=svg&dark=1&filename=vt-tool-split-view)
...
![Oś czasu Sequence Studio: transport, linijka, ścieżka nakładek, magnetyczny wiersz sekwencji z klipami i znacznikami styków oraz pas Always on](/t/url-shot?url=%2F%23%2Ftool%2Fsequence-studio&width=1440&height=900&dpi=192&waitMs=7000&css=.tl-panel%7Bheight%3A252px!important%7D&cropSelector=.tl-panel&format=svg&walker=1&tolerance=0.03&dark=1&filename=seq-studio-timeline)
...
![Cała powierzchnia edycji: obszar roboczy, listwa narzędzi i oś czasu razem](/t/url-shot?url=%2F%23%2Ftool%2Fsequence-studio&width=1440&height=900&dpi=192&waitMs=7000&css=.fc-toolbar%7Bopacity%3A1!important%7D&cropSelector=%23tool-stage&format=svg&walker=1&tolerance=0.03&dark=1&filename=seq-studio-stage)
...
- **Czy trafi tam twoje nazwisko.** Twoje imię i nazwisko, e-mail i organizacja są zapisywane w pliku tylko wtedy, gdy w profilu włączone jest **Use my details to create**. Przy wyłączonym plik zapisuje, że powstał w Lolly i kiedy - nic o tobie.
- **Czy trafi tam licencjonowana grafika.** Zasoby licencjonowane i zablokowane przez markę są domyślnie wstrzymywane. Jeśli projekt ich używa, okno podaje ile i daje dwa przyciski - *Download without them* albo *Include and download* - bo dołączenie ich wręcza właściwe pliki każdemu, kto otworzy `.lolly`.
- **Czy trafi tam narzędzie.** **Include the tool** pakuje własne pliki narzędzia razem z projektem, żeby otworzył się na urządzeniu, które tego narzędzia nie ma. Opcja przychodzi zaznaczona przy narzędziu niestandardowym - forku albo prywatnym narzędziu markowym, którego odbiorca raczej nie ma - i odznaczona przy takim, które zgadza się co do bajtu z podpisanym katalogiem, bo jego kopia to już ten sam plik.
...
- <!--i:upload--> **Wnieś swoje pliki.** Przeciągnij dowolny obraz, SVG, klip audio, wideo, plik Lottie, PDF albo prezentację PowerPoint na obszar wgrywania - albo kliknij, aby wybrać - a plik od razu ląduje w twoim katalogu, gotowy w oknie wyboru zasobów każdego narzędzia. Wielostronicowy PDF albo `.pptx` pyta, które strony lub slajdy zachować - każdy staje się zasobem SVG. Wczytuj, ile chcesz; nic nie opuszcza twojego urządzenia.
- <!--i:star--> **Oznacz ulubione, po które sięgasz.** ★ przy zasobie (albo próbce marki) przypina go na górze każdego okna wyboru, więc twoje podstawowe logo lub kolor są o jedno kliknięcie.
- <!--i:folder--> **Zrób porządek.** Przenieś zasób do innej grupy, ukryj współdzielony zasób marki, z którego nie korzystasz (**Show hidden** przywraca go z powrotem), albo usuń własne wgrane pliki na dobre. Ten sam gest zaznaczania wielokrotnego i pływający pasek akcji co w Projects działają również tutaj, więc każdą z tych rzeczy można zrobić na całym zaznaczeniu naraz.
