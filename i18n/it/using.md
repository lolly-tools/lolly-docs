...
![L'intera superficie di lavoro: area di disegno, barra degli strumenti e timeline insieme](/t/url-shot?url=%2F%23%2Ftool%2Fdesign%3Fz%3D11dZBb5swFADgX8MOiRYZB0J76GFpNO2wnbr7ZMwDrBg7s01C8usngmNwSqJszaT2aD8_G54_PUgJXRdK1iJ7CvAcpSHG6FMqG9BPQbwMkmWAMcsCjIP5lwDjUsp1O8DPAcZrJvpIKhsXaLpZ1I323mjXjcJHbCdKO4Ee7ISSxsvQJdmAO0cBNe6gtHDzQbKkkks101ARYRidaaBSZETtg2TlMgw0xuX8LBXANCN7PTVyWki3Kr-6b61yQmG4ay6FeWEHOL1K1E0TzgrhdqIgDCiXs_WjFcsyDi66A1aU_ZMuEPIOcwFNhHYRzgR8GySGs9CW0BDlFzWrVTe2qdCwftOcZP2TtJEfuovFyKZzIvor0fD7WKhVGzsXo2ALhH8UMxvFqmtiXmQFpmSimArYBfGzYHpKZcVEcS87-OHedpK72cHndmYWunu6rtxM-3wuwGqTXskacov-nhs15KNYG7HgWZtMvpNa0LJtUJNJi-2rYhnZ3ybtuNUVZuj9MotOrAbQFmPQbuB0uxwud4NX9-ycrmWIJw59Pg9h5AF6RGd-5vgWPhvG-2b5xs8bl5zvZ0ZK3tf_bd0pxu_lw2YDG2Jv6VRdj9Hi__WrKB7pV3OELuBKIRunReqM9f8d1tbnKPFsJVHs2Zqf9SaMLrSmASCjiNAbokD0lD0t_95Wxu-MVaQ4uT6WQ8ta0V46Z6lq9br1fVEOh7ypju-FFyjBC7fmVy0UaMm3YBcbVYMt-dhfTlUbe2BOuD6ujFd_AA&width=1440&height=900&dpi=192&waitMs=7000&waitSelector=.tl-clip&css=.fc-toolbar%7Bopacity%3A1!important%7D&format=svg&walker=1&tolerance=0.03&dark=1&filename=seq-studio-stage)
...
- **Se il tuo nome ci finisce dentro.** Il tuo nome, la tua email e la tua organizzazione vengono scritti nel file solo quando **Usa i miei dati per creare** è attivo nel tuo profilo. Con l'opzione disattivata, il file registra che è stato creato con Lolly e quando - niente su di te.
- **Se le opere in licenza ci finiscono dentro.** Gli asset in licenza e vincolati al brand sono trattenuti per impostazione predefinita. Se il design ne usa qualcuno, la finestra dice quanti sono e offre due pulsanti - *Scarica senza di essi* o *Includi e scarica* - perché includerli consegna i file veri e propri a chiunque apra il `.lolly`.
- **Se lo strumento ci finisce dentro.** **Includi lo strumento** impacchetta i file dello strumento insieme al design, così si apre su un dispositivo che non ha quello strumento. Arriva spuntato per uno strumento personalizzato - un fork o uno strumento di brand privato che è improbabile che il destinatario abbia - e non spuntato per uno che corrisponde byte per byte al catalogo firmato, dato che la loro copia è già lo stesso file.
...
- <!--i:upload--> **Porta dentro i tuoi file.** Trascina qualsiasi immagine, SVG, clip audio, video, Lottie, PDF o presentazione PowerPoint sull'area di caricamento - oppure fai clic per sceglierli - e atterra nel tuo catalogo all'istante, pronto nel selettore di asset di ogni strumento. Un PDF di più pagine o un `.pptx` chiede quali pagine o diapositive tenere - ognuna diventa un asset SVG. Importane quanti vuoi; non lasciano mai il tuo dispositivo.
- <!--i:star--> **Metti tra i preferiti ciò a cui ricorri.** Aggiungi una ★ a un asset (o a un campione di brand) e viene fissato in cima a ogni selettore, così il logo o il colore che usi di più è a un clic di distanza.
- <!--i:folder--> **Fai ordine.** Riclassifica un asset in un gruppo diverso, nascondi un asset di brand condiviso che non usi (con **Mostra nascosti** per riportarlo indietro) oppure elimina del tutto i tuoi caricamenti. Lo stesso gesto di selezione multipla e la stessa barra di azioni flottante di Progetti funzionano anche qui, quindi tutto questo si può fare su un'intera selezione in una volta sola.
