...
![Toda a superfície de edição: prancheta, barra de ferramentas e linha do tempo juntas](/t/url-shot?url=%2F%23%2Ftool%2Fsequence-studio&width=1440&height=900&dpi=192&waitMs=7000&css=.fc-toolbar%7Bopacity%3A1!important%7D&cropSelector=%23tool-stage&format=svg&walker=1&tolerance=0.03&dark=1&filename=seq-studio-stage)
...
- **Se o seu nome vai junto.** Seu nome, e-mail e organização só são gravados no arquivo quando **Usar meus dados para criar** está ativado no seu perfil. Com ele desativado, o arquivo registra que foi feito com o Lolly e quando - nada sobre você.
- **Se a arte licenciada vai junto.** Ativos licenciados e travados pela marca ficam de fora por padrão. Se o design usa algum, o diálogo diz quantos e oferece dois botões - *Baixar sem eles* ou *Incluir e baixar* - porque incluí-los entrega os arquivos de verdade a quem abrir o `.lolly`.
- **Se a ferramenta vai junto.** **Incluir a ferramenta** empacota os arquivos da própria ferramenta junto com o design, para que ele abra em um dispositivo que não tem essa ferramenta. Ela vem marcada para uma ferramenta personalizada - um fork ou uma ferramenta de marca privada que seu destinatário provavelmente não tem - e desmarcada para uma que confere byte a byte com o catálogo assinado, já que a cópia dele já é o mesmo arquivo.
...
- <!--i:upload--> **Traga seus arquivos.** Arraste qualquer imagem, SVG, clipe de áudio, vídeo, Lottie, PDF ou apresentação do PowerPoint para a área de upload - ou clique para escolher - e ele aparece no seu catálogo instantaneamente, pronto no seletor de ativos de todas as ferramentas. Um PDF de várias páginas ou um `.pptx` pergunta quais páginas ou slides manter - cada um vira um ativo SVG. Importe quanto quiser; nada sai do seu dispositivo.
- <!--i:star--> **Favorite o que você mais usa.** Marque um ativo (ou uma amostra da marca) com ★ e ele é fixado no topo de todos os seletores, deixando seu logo ou cor favoritos a um clique de distância.
- <!--i:folder--> **Organize.** Recategorize um ativo em um grupo diferente, oculte um ativo de marca compartilhado que você não usa (com **Mostrar ocultos** para trazê-lo de volta) ou exclua definitivamente seus próprios uploads. O mesmo gesto de seleção múltipla e a mesma barra de ações flutuante de Projetos funcionam aqui também, então qualquer uma dessas ações pode ser feita em uma seleção inteira de uma vez.
