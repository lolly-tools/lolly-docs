...
![Bir aracın bölünmüş görünümü - solda kontrol yığını, sağda çizdiği canlı gruplanmış sütun grafiği](/t/url-shot?url=%2F%23%2Ftool%2Fd3%3Fct%3Dbar%26t%3DExample%2520data%26st%3DSample%2520values%252C%2520not%2520a%2520real%2520dataset%26d%3DMonth%252CSeries%2520A%252CSeries%2520B%252CSeries%2520C%250AJan%252C12%252C9%252C5%250AFeb%252C18%252C14%252C7%250AMar%252C24%252C17%252C11%250AApr%252C29%252C23%252C15%26lg%3D1&width=1440&height=900&dpi=192&waitMs=2500&walker=1&format=svg&dark=1&filename=vt-tool-split-view)
...
![Tüm düzenleme yüzeyi: çalışma alanı, araç rayı ve zaman çizelgesi bir arada](/t/url-shot?url=%2F%23%2Ftool%2Fdesign%3Fz%3D11dZBb5swFADgX8MOiRYZB0J76GFpNO2wnbr7ZMwDrBg7s01C8usngmNwSqJszaT2aD8_G54_PUgJXRdK1iJ7CvAcpSHG6FMqG9BPQbwMkmWAMcsCjIP5lwDjUsp1O8DPAcZrJvpIKhsXaLpZ1I323mjXjcJHbCdKO4Ee7ISSxsvQJdmAO0cBNe6gtHDzQbKkkks101ARYRidaaBSZETtg2TlMgw0xuX8LBXANCN7PTVyWki3Kr-6b61yQmG4ay6FeWEHOL1K1E0TzgrhdqIgDCiXs_WjFcsyDi66A1aU_ZMuEPIOcwFNhHYRzgR8GySGs9CW0BDlFzWrVTe2qdCwftOcZP2TtJEfuovFyKZzIvor0fD7WKhVGzsXo2ALhH8UMxvFqmtiXmQFpmSimArYBfGzYHpKZcVEcS87-OHedpK72cHndmYWunu6rtxM-3wuwGqTXskacov-nhs15KNYG7HgWZtMvpNa0LJtUJNJi-2rYhnZ3ybtuNUVZuj9MotOrAbQFmPQbuB0uxwud4NX9-ycrmWIJw59Pg9h5AF6RGd-5vgWPhvG-2b5xs8bl5zvZ0ZK3tf_bd0pxu_lw2YDG2Jv6VRdj9Hi__WrKB7pV3OELuBKIRunReqM9f8d1tbnKPFsJVHs2Zqf9SaMLrSmASCjiNAbokD0lD0t_95Wxu-MVaQ4uT6WQ8ta0V46Z6lq9br1fVEOh7ypju-FFyjBC7fmVy0UaMm3YBcbVYMt-dhfTlUbe2BOuD6ujFd_AA&width=1440&height=900&dpi=192&waitMs=7000&waitSelector=.tl-clip&css=.fc-toolbar%7Bopacity%3A1!important%7D&format=svg&walker=1&tolerance=0.03&dark=1&filename=seq-studio-stage)
...
- **Adının içine girip girmeyeceği.** Adın, e-postan ve kurumun dosyaya yalnızca profilinde **Oluşturmak için bilgilerimi kullan** açıkken yazılır. Kapalıyken dosya, Lolly ile ve ne zaman yapıldığını kaydeder - senin hakkında hiçbir şey.
- **Lisanslı işlerin içine girip girmeyeceği.** Lisanslı ve markaya kilitli varlıklar varsayılan olarak tutulur. Tasarım bunlardan kullanıyorsa pencere kaç tane olduğunu söyler ve iki düğme sunar - *Onlarsız indir* ya da *Dahil et ve indir* - çünkü dahil etmek, gerçek dosyaları `.lolly`'yi açan herkese vermek demektir.
- **Aracın içine girip girmeyeceği.** **Aracı dahil et**, aracın kendi dosyalarını tasarımın yanına paketler, böylece o araca sahip olmayan bir cihazda da açılır. Özel bir araç için - bir çatal ya da alıcının muhtemelen sahip olmadığı özel bir marka aracı - işaretli gelir; imzalı katalogla bayt bayt eşleşen bir araç içinse işaretsiz gelir, çünkü onlardaki kopya zaten aynı dosyadır.
...
- <!--i:upload--> **Dosyalarını içeri getir.** Herhangi bir görseli, SVG'yi, ses klibini, videoyu, Lottie'yi, PDF'i ya da PowerPoint sunumunu yükleme alanının üzerine sürükle - ya da seçmek için tıkla - anında kataloğuna yerleşsin, her aracın varlık seçicisinde hazır olsun. Çok sayfalı bir PDF ya da bir `.pptx`, hangi sayfaların ya da slaytların tutulacağını sorar - her biri bir SVG varlığı olur. İstediğin kadar içe aktar; cihazından asla çıkmaz.
- <!--i:star--> **Sık uzandığını favorile.** Bir varlığı (ya da bir marka renk örneğini) ★ yıldızla, her seçicinin en üstüne sabitlensin; böylece gözde logon ya da rengin bir tık uzağında olur.
- <!--i:folder--> **Toparla.** Bir varlığı farklı bir gruba yeniden kategorize et, kullanmadığın paylaşılan bir marka varlığını gizle (geri getirmek için **Gizlenenleri göster** ile) ya da kendi yüklediklerini tamamen sil. Projeler'deki aynı çoklu seçim hareketi ve yüzen işlem çubuğu burada da çalışır, yani bunların hepsi bir kerede tüm bir seçime uygulanabilir.
