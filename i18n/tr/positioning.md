...
Böylece çıktıları onaylamayı bırakır, onları üreten **aracı** onaylamaya başlarsın. Bir kez onayla; ürettiği her varlık, yapısı gereği önceden onaylanmış olur - döngüde insan yok, inceleme turu yok, hangi hacimde olursa olsun.

Deterministik motorun gerçekten getirdiği paradigma değişimi bu: eski onay sürecinin daha hızlı bir versiyonu değil, süreci tümden ortadan kaldırıyor. Yaratıcı ekip için bir korkuluk, bir ikame değil - topu yine sen atıyorsun (veri, metin, görsel) ve kod, her atışı olukta kalmaktan koruyan bumper şeridi oluyor.

| Varlıkları eski yöntemle onaylamak | Aracı onaylamak, Lolly yöntemi |
|---|---|
| Bitmiş her dosya tek tek kontrol edilir | Araç bir kez kontrol edilir |
| Talep → tasarımcı üretir → marka incelemesi → hukuk kontrolü → değişiklikler → yeniden inceleme | Tek bir parametre değişikliği → bitmiş varlık |
| Tasarımcı, marka yöneticisi, hukuk ve talep sahibi, hepsi döngüde | Üretici, tek başına |
| Varlık başına günler | Varlık başına saniyeler |
| 10.000 varlık = 10.000 inceleme turu | 10.000 varlık = sıfır (şablon zaten onaylanmıştı) |
...
Bunlardan ilki, insanların en çok hafife aldığıdır. Poster kalitesinde bir şehir haritası: gerçek vektör yol ve su yollarıyla çizilmiş, tek bir açılır listeden ve markanın dışına yönlendirilemeyen iki renk alanından doğmuş.
