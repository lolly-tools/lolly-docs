...
> কয়েকটি টুল (যেমন **Design**) বদলে একটি **ফ্রি ক্যানভাস** হিসেবে খোলে — একটি ক্রোমহীন, সরাসরি-নিয়ন্ত্রণের সারফেস যেখানে আপনি টেক্সট, শেপ এবং ছবির বাক্স টেনে সরান, রিসাইজ, ঘোরান এবং স্ন্যাপ করেন, এবং টেক্সট জায়গায় বসেই এডিট করতে ডাবল-ক্লিক করেন। এটি অন্য প্রতিটি টুলের মতো একই রেন্ডার পাথ দিয়ে এক্সপোর্ট করে, তাই ক্যানভাসটাই *হলো* ফাইল। নিচে [ফ্রি ক্যানভাস](#the-free-canvas-design) দেখুন।
...
অ্যাসেট হলো খোলা, নিজে-করার পথের একটি অর্ধেক; অন্যটি হলো **আপনার নিজের টুল বানানো** — ফ্রি ক্যানভাস (Design, উপরে বর্ণিত) আপনাকে কোনো কোড ছাড়াই একটি দৃশ্যতভাবে বানাতে দেয়।
