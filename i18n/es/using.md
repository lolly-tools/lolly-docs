...
![La vista dividida de una herramienta - la pila de controles a la izquierda y el gráfico de barras agrupadas en vivo que dibuja a la derecha](/t/url-shot?url=%2F%23%2Ftool%2Fd3%3Fct%3Dbar%26t%3DExample%2520data%26st%3DSample%2520values%252C%2520not%2520a%2520real%2520dataset%26d%3DMonth%252CSeries%2520A%252CSeries%2520B%252CSeries%2520C%250AJan%252C12%252C9%252C5%250AFeb%252C18%252C14%252C7%250AMar%252C24%252C17%252C11%250AApr%252C29%252C23%252C15%26lg%3D1&width=1440&height=900&dpi=192&waitMs=2500&walker=1&format=svg&dark=1&filename=vt-tool-split-view)
...
![Toda la superficie de edición: área de diseño, barra de herramientas y línea de tiempo juntas](/t/url-shot?url=%2F%23%2Ftool%2Fdesign%3Fz%3D11dZBb5swFADgX8MOiRYZB0J76GFpNO2wnbr7ZMwDrBg7s01C8usngmNwSqJszaT2aD8_G54_PUgJXRdK1iJ7CvAcpSHG6FMqG9BPQbwMkmWAMcsCjIP5lwDjUsp1O8DPAcZrJvpIKhsXaLpZ1I323mjXjcJHbCdKO4Ee7ISSxsvQJdmAO0cBNe6gtHDzQbKkkks101ARYRidaaBSZETtg2TlMgw0xuX8LBXANCN7PTVyWki3Kr-6b61yQmG4ay6FeWEHOL1K1E0TzgrhdqIgDCiXs_WjFcsyDi66A1aU_ZMuEPIOcwFNhHYRzgR8GySGs9CW0BDlFzWrVTe2qdCwftOcZP2TtJEfuovFyKZzIvor0fD7WKhVGzsXo2ALhH8UMxvFqmtiXmQFpmSimArYBfGzYHpKZcVEcS87-OHedpK72cHndmYWunu6rtxM-3wuwGqTXskacov-nhs15KNYG7HgWZtMvpNa0LJtUJNJi-2rYhnZ3ybtuNUVZuj9MotOrAbQFmPQbuB0uxwud4NX9-ycrmWIJw59Pg9h5AF6RGd-5vgWPhvG-2b5xs8bl5zvZ0ZK3tf_bd0pxu_lw2YDG2Jv6VRdj9Hi__WrKB7pV3OELuBKIRunReqM9f8d1tbnKPFsJVHs2Zqf9SaMLrSmASCjiNAbokD0lD0t_95Wxu-MVaQ4uT6WQ8ta0V46Z6lq9br1fVEOh7ypju-FFyjBC7fmVy0UaMm3YBcbVYMt-dhfTlUbe2BOuD6ujFd_AA&width=1440&height=900&dpi=192&waitMs=7000&waitSelector=.tl-clip&css=.fc-toolbar%7Bopacity%3A1!important%7D&format=svg&walker=1&tolerance=0.03&dark=1&filename=seq-studio-stage)
...
- **Si va tu nombre.** Tu nombre, tu correo y tu organización se escriben en el archivo solo cuando **Usar mis datos para crear** está activado en tu perfil. Con la opción desactivada, el archivo registra que se hizo con Lolly y cuándo - nada sobre ti.
- **Si va el material con licencia.** Los recursos con licencia y bloqueados por marca se retienen de forma predeterminada. Si el diseño usa alguno, el diálogo dice cuántos y ofrece dos botones - *Descargar sin ellos* o *Incluir y descargar* - porque incluirlos entrega los archivos reales a quien abra el `.lolly`.
- **Si va la herramienta.** **Incluir la herramienta** empaqueta los archivos de la propia herramienta junto al diseño, para que se abra en un dispositivo que no la tiene. Llega marcada para una herramienta personalizada - una bifurcación o una herramienta de marca privada que es poco probable que tenga quien la recibe - y sin marcar para una que coincide byte a byte con el catálogo firmado, ya que su copia es justo el mismo archivo.
...
- <!--i:upload--> **Trae tus archivos.** Arrastra cualquier imagen, SVG, clip de audio, vídeo, Lottie, PDF o presentación de PowerPoint al área de subida - o haz clic para elegir - y aterriza en tu catálogo al instante, listo en el selector de recursos de cada herramienta. Un PDF de varias páginas o un `.pptx` pregunta qué páginas o diapositivas conservar - cada una se convierte en un recurso SVG. Incorpora tanto como quieras; nunca sale de tu dispositivo.
- <!--i:star--> **Marca como favorito lo que más usas.** Pon ★ a un recurso (o a una muestra de marca) y se fija en la parte superior de cada selector, así tu logo o color de referencia está a un clic de distancia.
- <!--i:folder--> **Ordena.** Recategoriza un recurso en otro grupo, oculta un recurso de marca compartido que no uses (con **Mostrar ocultos** para recuperarlo) o elimina directamente tus propias subidas. El mismo gesto de selección múltiple y la misma barra de acciones flotante de Proyectos funcionan también aquí, así que cualquiera de esas acciones se puede aplicar a toda una selección a la vez.
