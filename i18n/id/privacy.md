...
deskripsi tentang apa yang dilakukan kode saat ini, tetapi juga batas yang dijaga peramban untuk
aplikasi: perubahan di masa depan yang mencoba menghubungi host lain akan diblokir,
bukan diizinkan secara diam-diam. Dua baris tidak memiliki host tetap, karena Anda memilih
alamatnya pada saat penggunaan: URL yang Anda minta ditangkap oleh tool, dan
instans jarak jauh yang Anda arahkan pada shell. Tak satu pun ada dalam kebijakan, dan masing-masing hanya terjadi
saat Anda mengetik alamat dan bertindak atasnya. Deployment yang tidak menginginkan
fitur opsional apa pun (misalnya instans enterprise dengan font sendiri) menghapus
host-host itu dari kebijakannya dan fitur-fiturnya gagal secara tertutup alih-alih menghubungi keluar.
