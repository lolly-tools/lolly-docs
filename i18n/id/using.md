...
![Seluruh permukaan penyuntingan: artboard, rel tool dan timeline sekaligus](/t/url-shot?url=%2F%23%2Ftool%2Fdesign%3Fz%3D11dZBb5swFADgX8MOiRYZB0J76GFpNO2wnbr7ZMwDrBg7s01C8usngmNwSqJszaT2aD8_G54_PUgJXRdK1iJ7CvAcpSHG6FMqG9BPQbwMkmWAMcsCjIP5lwDjUsp1O8DPAcZrJvpIKhsXaLpZ1I323mjXjcJHbCdKO4Ee7ISSxsvQJdmAO0cBNe6gtHDzQbKkkks101ARYRidaaBSZETtg2TlMgw0xuX8LBXANCN7PTVyWki3Kr-6b61yQmG4ay6FeWEHOL1K1E0TzgrhdqIgDCiXs_WjFcsyDi66A1aU_ZMuEPIOcwFNhHYRzgR8GySGs9CW0BDlFzWrVTe2qdCwftOcZP2TtJEfuovFyKZzIvor0fD7WKhVGzsXo2ALhH8UMxvFqmtiXmQFpmSimArYBfGzYHpKZcVEcS87-OHedpK72cHndmYWunu6rtxM-3wuwGqTXskacov-nhs15KNYG7HgWZtMvpNa0LJtUJNJi-2rYhnZ3ybtuNUVZuj9MotOrAbQFmPQbuB0uxwud4NX9-ycrmWIJw59Pg9h5AF6RGd-5vgWPhvG-2b5xs8bl5zvZ0ZK3tf_bd0pxu_lw2YDG2Jv6VRdj9Hi__WrKB7pV3OELuBKIRunReqM9f8d1tbnKPFsJVHs2Zqf9SaMLrSmASCjiNAbokD0lD0t_95Wxu-MVaQ4uT6WQ8ta0V46Z6lq9br1fVEOh7ypju-FFyjBC7fmVy0UaMm3YBcbVYMt-dhfTlUbe2BOuD6ujFd_AA&width=1440&height=900&dpi=192&waitMs=7000&waitSelector=.tl-clip&css=.fc-toolbar%7Bopacity%3A1!important%7D&format=svg&walker=1&tolerance=0.03&dark=1&filename=seq-studio-stage)
...
- **Apakah nama Anda ikut masuk.** Nama, email dan organisasi Anda hanya ditulis ke dalam berkas ketika **Use my details to create** aktif di profil Anda. Bila mati, berkas hanya mencatat bahwa ia dibuat dengan Lolly dan kapan - tidak ada apa pun tentang Anda.
- **Apakah karya berlisensi ikut masuk.** Aset berlisensi dan yang terkunci brand ditahan secara bawaan. Jika desainnya memakai aset semacam itu, dialog menyebutkan berapa banyak dan menawarkan dua tombol - *Download without them* atau *Include and download* - karena menyertakannya berarti menyerahkan berkas aslinya kepada siapa pun yang membuka `.lolly` itu.
- **Apakah tool-nya ikut masuk.** **Include the tool** mengemas berkas milik tool itu bersama desainnya, sehingga desainnya terbuka di perangkat yang tidak punya tool tersebut. Opsi ini datang dalam keadaan tercentang untuk tool khusus - hasil fork atau tool brand privat yang kemungkinan tidak dimiliki penerima Anda - dan tidak tercentang untuk tool yang sama persis byte demi byte dengan katalog bertanda tangan, karena salinan mereka sudah berkas yang sama.
...
- <!--i:upload--> **Masukkan berkas Anda.** Seret gambar, SVG, klip audio, video, Lottie, PDF atau dek PowerPoint apa pun ke area unggah - atau klik untuk memilih - dan berkas itu langsung masuk ke katalog Anda, siap di pemilih aset setiap tool. PDF banyak halaman atau `.pptx` akan menanyakan halaman atau slide mana yang disimpan - masing-masing menjadi satu aset SVG. Masukkan sebanyak yang Anda mau; semuanya tidak pernah keluar dari perangkat Anda.
- <!--i:star--> **Favoritkan yang sering Anda ambil.** Beri ★ pada sebuah aset (atau swatch brand) dan aset itu tersemat di puncak setiap pemilih, sehingga logo atau warna andalan Anda hanya sejauh satu klik.
- <!--i:folder--> **Rapikan.** Pindahkan sebuah aset ke kelompok lain, sembunyikan aset brand bersama yang tidak Anda pakai (dengan **Show hidden** untuk memunculkannya kembali) atau hapus sama sekali unggahan Anda sendiri. Gestur pilih-banyak dan bilah aksi mengambang yang sama seperti di Projects juga berlaku di sini, jadi semua itu bisa dilakukan pada satu seleksi utuh sekaligus.
