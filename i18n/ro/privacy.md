...
descriere a ce face codul astăzi, este limita la care browserul ține aplicația: o
schimbare viitoare care ar încerca să contacteze vreun alt host ar fi blocată,
nu permisă în tăcere. Două rânduri nu au host fix, pentru că alegi tu
adresa în momentul utilizării: un URL pe care ceri unui tool să-l captureze, și o
instanță la distanță către care îndrepți shell-ul. Niciuna dintre ele nu e în politică, și fiecare se întâmplă doar
când tastezi o adresă și acționezi asupra ei. O implementare care nu vrea niciuna dintre cele
opționale (o instanță enterprise cu propriile fonturi, de exemplu) elimină acele
host-uri din politica sa, iar funcțiile eșuează cu blocare, în loc să contacteze extern.
