...
![Ang buong editing surface: artboard, tool rail at timeline nang magkakasama](/t/url-shot?url=%2F%23%2Ftool%2Fdesign%3Fz%3D11dZBb5swFADgX8MOiRYZB0J76GFpNO2wnbr7ZMwDrBg7s01C8usngmNwSqJszaT2aD8_G54_PUgJXRdK1iJ7CvAcpSHG6FMqG9BPQbwMkmWAMcsCjIP5lwDjUsp1O8DPAcZrJvpIKhsXaLpZ1I323mjXjcJHbCdKO4Ee7ISSxsvQJdmAO0cBNe6gtHDzQbKkkks101ARYRidaaBSZETtg2TlMgw0xuX8LBXANCN7PTVyWki3Kr-6b61yQmG4ay6FeWEHOL1K1E0TzgrhdqIgDCiXs_WjFcsyDi66A1aU_ZMuEPIOcwFNhHYRzgR8GySGs9CW0BDlFzWrVTe2qdCwftOcZP2TtJEfuovFyKZzIvor0fD7WKhVGzsXo2ALhH8UMxvFqmtiXmQFpmSimArYBfGzYHpKZcVEcS87-OHedpK72cHndmYWunu6rtxM-3wuwGqTXskacov-nhs15KNYG7HgWZtMvpNa0LJtUJNJi-2rYhnZ3ybtuNUVZuj9MotOrAbQFmPQbuB0uxwud4NX9-ycrmWIJw59Pg9h5AF6RGd-5vgWPhvG-2b5xs8bl5zvZ0ZK3tf_bd0pxu_lw2YDG2Jv6VRdj9Hi__WrKB7pV3OELuBKIRunReqM9f8d1tbnKPFsJVHs2Zqf9SaMLrSmASCjiNAbokD0lD0t_95Wxu-MVaQ4uT6WQ8ta0V46Z6lq9br1fVEOh7ypju-FFyjBC7fmVy0UaMm3YBcbVYMt-dhfTlUbe2BOuD6ujFd_AA&width=1440&height=900&dpi=192&waitMs=7000&waitSelector=.tl-clip&css=.fc-toolbar%7Bopacity%3A1!important%7D&format=svg&walker=1&tolerance=0.03&dark=1&filename=seq-studio-stage)
...
- **Kung isasama ang pangalan mo.** Isinusulat sa file ang pangalan, email at organisasyon mo kapag naka-on lang ang **Use my details to create** sa profile mo. Kapag naka-off ito, itinatala ng file na ginawa ito gamit ang Lolly at kung kailan - wala tungkol sa iyo.
- **Kung isasama ang lisensiyadong likha.** Pinipigil bilang default ang mga lisensiyado at brand-locked na asset. Kung may ginagamit ang disenyo, sinasabi ng dialog kung ilan at nag-aalok ito ng dalawang button - *Download without them* o *Include and download* - dahil ang pagsama sa mga ito ay iniaabot ang mismong file sa kung sinuman ang magbubukas ng `.lolly`.
- **Kung isasama ang tool.** Ang **Include the tool** ay ibinabalot ang sariling mga file ng tool kasama ang disenyo, para bumukas ito sa isang device na walang ganoong tool. Dumarating itong may tsek para sa isang custom na tool - isang fork o isang pribadong brand na tool na malamang na wala sa tatanggap mo - at walang tsek para sa isang tugmang-tugma sa nilagdaang catalogue, byte kada byte, dahil pareho na ang file ng kopya nila.
...
- <!--i:upload--> **Ipasok ang mga file mo.** I-drag ang anumang larawan, SVG, audio clip, video, Lottie, PDF o PowerPoint na deck papunta sa upload area - o mag-click para pumili - at agad itong mapupunta sa catalogue mo, handa na sa asset picker ng bawat tool. Ang PDF na maraming pahina o isang `.pptx` ay nagtatanong kung aling mga pahina o slide ang itatago - bawat isa ay nagiging isang SVG na asset. Magpasok ng kasindami ng gusto mo; hindi ito kailanman umaalis sa device mo.
- <!--i:star--> **I-favourite ang madalas mong abutin.** Lagyan ng ★ ang isang asset (o isang brand swatch) at maididikit ito sa itaas ng bawat picker, kaya isang click lang ang layo ng palagi mong logo o kulay.
- <!--i:folder--> **Maglinis.** Ilipat ang isang asset sa ibang grupo, itago ang isang ibinahaging brand asset na hindi mo ginagamit (may **Show hidden** para ibalik ito) o burahin nang tuluyan ang sarili mong mga upload. Gumagana rin dito ang parehong multi-select na galaw at lumulutang na action bar gaya sa Projects, kaya puwedeng gawin ang alinman doon sa isang buong napili nang sabay-sabay.
