...
isang paglalarawan kung ano ang ginagawa ng code ngayon, ito ang hangganan na
pinananatili ng browser sa app: kung ang isang pagbabago sa hinaharap ay
susubukang makipag-ugnayan sa ibang host, ito ay hahadlangan, hindi tahimik na
papayagan. Dalawang row ang walang fixed host, dahil pinipili mo ang address sa
sandali ng paggamit: isang URL na hinihiling mong kunan ng litrato ng tool, at
isang remote instance na itinuro mo sa shell. Wala sa dalawa ang nasa patakaran,
at bawat isa ay nangyayari lang kapag nag-type ka ng address at kumilos dito. Ang
isang deployment na ayaw sa kahit alin sa mga opsyonal (isang enterprise instance
na may sariling font, halimbawa) ay inaalis ang mga host na iyon mula sa
patakaran nito at ang mga feature ay nabibigo nang closed sa halip na
makipag-ugnayan.
