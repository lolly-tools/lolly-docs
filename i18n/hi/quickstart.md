...
- <!--i:palette--> **ऐप में:** [डिज़ाइन सिस्टम बिल्डर: ब्रांड स्टूडियो](/info/brand-studio.html) (`#/start`) सीधे कोई टोकन फ़ाइल, Penpot एक्सपोर्ट या `LollyBrand` पैक स्वीकार करता है — उसे ड्रॉप करें और पैलेट जगमगा उठता है।
...
- <!--i:link--> **लिंक शेयर करें।** हर टूल स्टेट एक URL है, इसलिए हर तैयार एसेट दोबारा बनाया जा सकता है और पैरामीटर से संबोधित होता है — लिंक कमिट करें, माँग पर दोबारा जनरेट करें।
- <!--i:layers--> **थोक में करें।** [बैच ग्रिड](/info/exporting.html) में किसी स्प्रेडशीट से टेम्पलेट चलाएँ: हर पंक्ति के लिए एक तैयार एसेट।
...
- <!--i:code--> **[बिल्डर्स के लिए Lolly](/info/builders.html)** — आप टूल बनाते हैं, इंटीग्रेट करते हैं और डिप्लॉय करते हैं। तकनीकी दस्तावेज़ीकरण।
