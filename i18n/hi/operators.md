...
### एक फ़्यूचर-प्रूफ़, डिफ़ेंस-इन-डेप्थ, डेटा-लॉस-प्रिवेंशन और प्रोवेनेंस रणनीति – जो संयोग से एक क्रिएटिव प्रोडक्शन प्लैटफ़ॉर्म भी है

यह वह संगठनात्मक इम्यून सिस्टम है जो आपके पहले से चल रहे कामकाज के इर्द-गिर्द लिपट जाता है — ताकि आपकी टीमों को हर दिन जिस रूटीन क्रिएटिव काम की ज़रूरत होती है, वह आपकी परिधि से बाहर लीक होने के बजाय उसके *भीतर* ही हो।

**इसमें आपके लिए क्या है।** आप वह व्यक्ति बनते हैं जिसने किसी ऐसी चीज़ को हाँ कहा जो सुरक्षित *भी* है और लोकप्रिय भी। आप एक ही कदम में एक एक्सफ़िल्ट्रेशन छेद बंद करते हैं और डिज़ाइन-रिक्वेस्ट कतार को मिटा देते हैं — वह दुर्लभ सुरक्षा जीत जो आपको कम नहीं, ज़्यादा पसंद किया जाने वाला बनाती है। रात 3 बजे की कोई कॉल नहीं क्योंकि किसी ने ब्रैंड फ़ाइलें किसी कॉन्ट्रैक्टर को ईमेल कर दीं या ग्राहक डेटा किसी अनजान वेब टूल में पेस्ट कर दिया; आपके ज़िम्मे कम SaaS वेंडर, कॉन्ट्रैक्ट और ऑडिट; और एक पूरा git ट्रेल जिसे आप दिखा सकते हैं जब कोई पूछे कि किसने क्या मंज़ूर किया। आप रात में चैन से सोते हैं।

Lolly एक क्रिएटिव टूल के रूप में अपनी जगह खुद कमाता है: यह डिज़ाइन कतार को मिटा देता है और प्रोडक्शन-क्वालिटी आउटपुट हर किसी के हाथ में रख देता है। लेकिन इसे इतने बड़े पैमाने पर बाँटना जिस वजह से *सुरक्षित* है, वह वजह आर्किटेक्चरल है। कुछ भी अपलोड नहीं होता, सब कुछ पुनरुत्पादनीय है, और हर एक्सपोर्ट अपने स्रोत का क्रिप्टोग्राफ़िक रिकॉर्ड साथ ले जा सकता है। यह पेज सुरक्षा और रोलआउट की कहानी है।
...
Lolly का एक लक्ष्य **डिज़ाइन-रिक्वेस्ट डिफ़्लेक्शन**: ऐसी रूटीन रिक्वेस्ट जिन्हें कभी किसी डिज़ाइनर तक पहुँचने की ज़रूरत ही नहीं पड़ती, क्योंकि जिस व्यक्ति को एसेट चाहिए था उसने उसे खुद, सही ढंग से, मिनटों में बना लिया। हर डिफ़्लेक्ट हुआ टिकट एक प्रोडक्टिविटी जीत भी है और हाथ बदलने वाली एक फ़ाइल कम भी।
...
Lolly टूल्स की एक श्रेणी *ख़ास तौर पर* फ़ाइलों को परिधि के भीतर रखने के लिए मौजूद है। प्राइवेसी यूटिलिटी।
...
- **PDF कंप्रेस करें**
'ईमेल लिमिट संकट' की किसी भी आशंका को रोकें, जहाँ थर्ड-पार्टी वेब टूल घात लगाए रहते हैं और डेटा 

- **PDF कंप्रेस करें**
'ईमेल लिमिट संकट' की किसी भी आशंका को रोकें, जहाँ थर्ड-पार्टी वेब टूल घात लगाए रहते हैं और डेटा खिड़की से बाहर गिर जाता है। 
...
- **सत्यापन ऑन-डिवाइस होता है।** कोई भी फ़ाइल `/valid` पर (या `lolly validate <file>` में) डालें और ऑफ़लाइन रिपोर्ट पाएँ कि वह वाक़ई Lolly से बनी है और तब से अपरिवर्तित है या नहीं। देखें [Content Credentials पहचान](/info/content-credentials-identity.html)।

> **इंटरऑपरेबिलिटी नोट।** Lolly आज अपने क्रेडेंशियल और कई थर्ड-पार्टी क्रेडेंशियल ऑफ़लाइन सत्यापित करता है। दो इंटरऑप काम प्रगति पर हैं: दूसरे निर्माताओं के C2PA क्लेम **v2** मैनिफ़ेस्ट को पूरी तरह पढ़ना, और WebM — जिसके लिए अभी कोई मानकीकृत C2PA मैपिंग नहीं है, इसलिए Lolly मैनिफ़ेस्ट को Matroska हिस्से के रूप में जोड़ता है (थर्ड-पार्टी टूल Lolly की MP4 को सीधे सत्यापित कर लेते हैं; मानक तय होते ही WebM भी आ जाएगा)।
