...
![The whole editing surface: artboard, tool rail and timeline together](/t/url-shot?url=%2F%23%2Ftool%2Fdesign%3Fz%3D11dZBb5swFADgX8MOiRYZB0J76GFpNO2wnbr7ZMwDrBg7s01C8usngmNwSqJszaT2aD8_G54_PUgJXRdK1iJ7CvAcpSHG6FMqG9BPQbwMkmWAMcsCjIP5lwDjUsp1O8DPAcZrJvpIKhsXaLpZ1I323mjXjcJHbCdKO4Ee7ISSxsvQJdmAO0cBNe6gtHDzQbKkkks101ARYRidaaBSZETtg2TlMgw0xuX8LBXANCN7PTVyWki3Kr-6b61yQmG4ay6FeWEHOL1K1E0TzgrhdqIgDCiXs_WjFcsyDi66A1aU_ZMuEPIOcwFNhHYRzgR8GySGs9CW0BDlFzWrVTe2qdCwftOcZP2TtJEfuovFyKZzIvor0fD7WKhVGzsXo2ALhH8UMxvFqmtiXmQFpmSimArYBfGzYHpKZcVEcS87-OHedpK72cHndmYWunu6rtxM-3wuwGqTXskacov-nhs15KNYG7HgWZtMvpNa0LJtUJNJi-2rYhnZ3ybtuNUVZuj9MotOrAbQFmPQbuB0uxwud4NX9-ycrmWIJw59Pg9h5AF6RGd-5vgWPhvG-2b5xs8bl5zvZ0ZK3tf_bd0pxu_lw2YDG2Jv6VRdj9Hi__WrKB7pV3OELuBKIRunReqM9f8d1tbnKPFsJVHs2Zqf9SaMLrSmASCjiNAbokD0lD0t_95Wxu-MVaQ4uT6WQ8ta0V46Z6lq9br1fVEOh7ypju-FFyjBC7fmVy0UaMm3YBcbVYMt-dhfTlUbe2BOuD6ujFd_AA&width=1440&height=900&dpi=192&waitMs=7000&waitSelector=.tl-clip&css=.fc-toolbar%7Bopacity%3A1!important%7D&format=svg&walker=1&tolerance=0.03&dark=1&filename=seq-studio-stage)
...
**प्रीसेट से आगे: कीफ़्रेम, गहराई और एक कैमरा।** ट्रांज़िशन किसी क्लिप को उसके आने और जाने पर ऐनिमेट करता है। किसी बॉक्स को क्लिप के *भीतर* पोज़ करने के लिए - उसे बहाना, फ़ेड करना, धुँधलाना, पन्ने से उठाकर वापस बिठाना - कीफ़्रेम जोड़ें: क्लिप चुनें, **+Keyframe** दबाएँ (टाइमलाइन के टूल समूह वाला हीरा, कैनवस के ऑब्जेक्ट बार वाला हीरा, या `K`) और प्लेहेड की स्थिति तय करती है कि आपका अगला संपादन कौन-सा पोज़ लिखेगा। यही तंत्र हर समयबद्ध कंपोज़िशन को एक **कैमरा** देता है जो भीतर धकेलता है, आर-पार पैन करता है और फ़ोकस खींचता है, और एक चपटी SVG को परतों के ऐसे ढेर में बदल देता है जिनके बीच आप उड़ सकते हैं। पूरी गाइड है **[ऐनिमेट करना](/info/animating.html)**।
...
- **कियोस्क।** किसी आर्टबोर्ड को **Length** दें और डेक उतनी देर वहीं रुकता है, फिर एक पतली प्रोग्रेस बार के पीछे ख़ुद आगे बढ़ जाता है; `K` (या पॉज़ बटन, जो तभी दिखता है जब किसी चीज़ की लंबाई तय हो) उसे रोकता और फिर चालू करता है। लिंक में `loop` जोड़ें और डेक अंत में लौटकर फिर चलने लगता है, और यही उसे साइनेज बनाता है।
...
किसी लाइव [सहयोग](/info/collaborate.html) में हिस्ट्री सिर्फ़ आपकी रहती है। दूसरे डिवाइस से आया बदलाव कभी आपके स्टैक पर नहीं आता, इसलिए अनडू सिर्फ़ वही वापस ले सकता है जो आपने ख़ुद किया हो।
...
- **आपका नाम इसमें जाए या नहीं।** आपका नाम, ईमेल और संगठन फ़ाइल में तभी लिखे जाते हैं जब आपकी प्रोफ़ाइल में **Use my details to create** चालू हो। बंद होने पर फ़ाइल सिर्फ़ यह दर्ज करती है कि वह Lolly से बनी और कब बनी - आपके बारे में कुछ नहीं।
- **लाइसेंस वाली सामग्री इसमें जाए या नहीं।** लाइसेंस वाले और ब्रांड-लॉक एसेट डिफ़ॉल्ट रूप से रोक लिए जाते हैं। अगर डिज़ाइन में ऐसा कुछ है, तो डायलॉग बताता है कि कितने हैं और दो बटन देता है - *Download without them* या *Include and download* - क्योंकि उन्हें शामिल करने का मतलब है असली फ़ाइलें उस हर व्यक्ति को सौंप देना जो `.lolly` खोले।
- **टूल इसमें जाए या नहीं।** **Include the tool** डिज़ाइन के साथ टूल की अपनी फ़ाइलें भी पैक कर देता है, ताकि वह ऐसे डिवाइस पर भी खुले जिसके पास वह टूल नहीं है। किसी कस्टम टूल के लिए - किसी फ़ोर्क या निजी ब्रांड टूल के लिए, जो आपके पाने वाले के पास शायद ही हो - यह पहले से टिक रहता है, और उस टूल के लिए बिना टिक जो हस्ताक्षरित कैटलॉग से बाइट-दर-बाइट मेल खाता है, क्योंकि उनकी प्रति पहले से वही फ़ाइल है।

**इसे खोलना।** कोई `.lolly` ऐप पर छोड़ दें: एसेट आपकी लाइब्रेरी में आ जाते हैं, सेशन Projects में और टूल उसी पर खुल जाता है। आपका कुछ भी अधिलेखित नहीं होता: सेशन एक नए सहेजे गए स्लॉट के रूप में आता है, और इस डिवाइस पर पहले से मौजूद एसेट चेकसम से पहचानकर दोबारा इस्तेमाल कर लिया जाता है, उसकी नक़ल नहीं बनती। आते समय हर हिस्सा फ़ाइल के अपने चेकसम से जाँचा जाता है, इसलिए रास्ते में क्षतिग्रस्त हुई प्रति आधी-अधूरी इंपोर्ट होने के बजाय अस्वीकार कर दी जाती है।
...
- <!--i:upload--> **अपनी फ़ाइलें लाएँ।** कोई भी इमेज, SVG, ऑडियो क्लिप, वीडियो, Lottie, PDF या PowerPoint डेक अपलोड क्षेत्र पर खींचें - या क्लिक करके चुनें - और वह तुरंत आपके कैटलॉग में आ जाती है, हर टूल के एसेट पिकर में तैयार। कई पेज वाली PDF या कोई `.pptx` पूछती है कि कौन-से पेज या स्लाइड रखने हैं - हर एक एक SVG एसेट बन जाता है। जितना चाहें उतना लाएँ; कुछ भी आपके डिवाइस से बाहर नहीं जाता।
- <!--i:star--> **जो बार-बार चाहिए उसे पसंदीदा बनाएँ।** किसी एसेट (या ब्रांड स्वैच) को ★ करें और वह हर पिकर में सबसे ऊपर पिन हो जाता है, ताकि आपका काम का लोगो या रंग एक क्लिक की दूरी पर रहे।
- <!--i:folder--> **सफ़ाई रखें।** किसी एसेट को किसी दूसरे समूह में पुनर्वर्गीकृत करें, जिस साझा ब्रांड एसेट का आप उपयोग नहीं करते उसे छिपा दें (**Show hidden** से वापस लाएँ) या अपने अपलोड सीधे हटा दें। वही मल्टी-सेलेक्ट इशारा और तैरती ऐक्शन बार, जो Projects में है, यहाँ भी चलती है, इसलिए इनमें से कुछ भी पूरे चयन पर एक साथ किया जा सकता है।
...
Batch *एक ही* डिज़ाइन के कई वैरिएंट है। **Multi-edit** काम का दूसरा आधा हिस्सा है: कई **अलग-अलग** सहेजे गए डिज़ाइन एक साथ खुले, ताकि एक बदलाव उन सब पर लागू हो। **Projects** में **दो से आठ** सहेजे गए सेशन टिक करें और सिलेक्शन बार से **Edit together** चुनें; वे `#/multi?s=<slot>,<slot>…` पर अगल-बगल लाइव कार्ड के रूप में खुलते हैं। हर कार्ड उस सेशन का असली रेंडर है, कोई संग्रहीत थंबनेल नहीं, इसलिए जो दिखता है वही एक्सपोर्ट होगा।
