...
- **आगे बढ़ें** **Space**, `→`, **Page Down** से या स्क्रीन के दाएँ किनारे की पट्टी पर क्लिक करके; पीछे जाएँ `←`, **Page Up** या बाएँ किनारे की पट्टी से। **Home** और **End** पहली और आख़िरी स्लाइड पर ले जाते हैं। पॉइंटर हिलाते ही कंट्रोल की एक छोटी बार दिखने लगती है और रुकते ही ख़ुद छिप जाती है।
- **Overview** (`O` या ग्रिड बटन) हर आर्टबोर्ड को एक साथ उसी सजावट में रखकर दिखाता है जो आपने कैनवस पर दी थी; किसी एक पर क्लिक करके उसे खोलें।
- **चरणों में दिखाना।** किसी बॉक्स पर राइट-क्लिक करें और डिफ़ॉल्ट **Always visible** के बजाय **Reveal at step 1**, **2** या **3** चुनें। फिर वह बॉक्स तब तक रुका रहता है जब तक आप उसके चरण पर नहीं पहुँचते, ताकि स्लाइड टुकड़ों में आ सके; एक ही संख्या वाले बॉक्स साथ आते हैं।
- **Speaker view** (`S`) एक दूसरी विंडो खोलता है जिसमें मौजूदा स्लाइड, अगली आने वाली स्लाइड, उस स्लाइड के लिए आपके नोट और चलती हुई घड़ी होती है। अगर ब्राउज़र पॉप-अप रोक दे, तो यह डेक के ऊपर एक पैनल पर लौट आता है। नोट हर आर्टबोर्ड के लिए अलग सेट होते हैं और स्लाइड पर कभी नहीं दिखते।
- `B` काली स्क्रीन रोके रखता है (कोई भी कुंजी स्लाइड वापस ले आती है), `F` फ़ुलस्क्रीन पर लौटाता है और **Escape** एक बार में एक परत हटाता है: ओवरव्यू से डेक पर, डेक से एडिटर पर।
- **कियोस्क।** किसी आर्टबोर्ड को **Length** दें और डेक उतनी देर वहीं रुकता है, फिर एक पतली प्रोग्रेस बार के पीछे ख़ुद आगे बढ़ जाता है; `K` (या पॉज़ बटन, जो तभी दिखता है जब किसी चीज़ की लंबाई तय हो) उसे रोकता और फिर चालू करता है। लिंक में `kiosk` जोड़ें और डेक अंत में लौटकर फिर चलने लगता है, और यही उसे साइनेज बनाता है।
...
- <!--i:folder--> **नेस्ट होने वाले फ़ोल्डर।** सहेजे गए सेशनों को फ़ोल्डरों में, और फ़ोल्डरों के भीतर फ़ोल्डरों में, जितनी गहराई तक चाहें, समूहित करें। फ़ोल्डर बनाएँ, नाम बदलें, या किसी टाइल को दूसरे फ़ोल्डर पर खींचकर उसे वहाँ ले जाएँ; ब्रेडक्रम्ब आपको वापस ऊपर ले आता है। हमेशा मौजूद **Uncategorised** फ़ोल्डर में वह सब रहता है जो अभी तक कहीं रखा नहीं गया।
...
- <!--i:document--> **नया काम सीधे यहीं दर्ज करें।** **New asset** (रूट पर "Start a fresh creation", किसी फ़ोल्डर के भीतर "Add to *folder*") एक टूल खोलता है और उसकी पहली सेव अपने आप उसी फ़ोल्डर में रख देता है।
