...
- <!--i:upload--> **अपनी फ़ाइलें लाएँ।** किसी भी इमेज, SVG, ऑडियो क्लिप, वीडियो, Lottie, PDF या PowerPoint डेक को अपलोड एरिया पर खींचें - या चुनने के लिए क्लिक करें - और यह तुरंत आपके कैटलॉग में आ जाता है, हर टूल के एसेट पिकर में तैयार। एक मल्टी-पेज PDF या `.pptx` पूछता है कौन-से पेज या स्लाइड रखने हैं - हर एक SVG एसेट बन जाता है। जितना चाहें उतना इनजेस्ट करें; यह कभी आपके डिवाइस से बाहर नहीं जाता।
- <!--i:star--> **जो बार-बार इस्तेमाल करते हैं उसे पसंदीदा बनाएँ।** किसी एसेट (या ब्रांड स्वैच) को ★ करें और यह हर पिकर के सबसे ऊपर पिन हो जाता है, ताकि आपका पसंदीदा लोगो या रंग एक क्लिक दूर रहे।
- <!--i:folder--> **व्यवस्थित रखें।** किसी एसेट को दूसरे समूह में पुनर्वर्गीकृत करें, कोई शेयर किया गया ब्रांड एसेट जो आप इस्तेमाल नहीं करते उसे छिपाएँ (**Show hidden** से वापस लाया जा सकता है) या अपने अपलोड सीधे हटा दें। यहाँ भी Projects जैसा ही मल्टी-सिलेक्ट जेस्चर और फ़्लोटिंग एक्शन बार काम करता है, तो यह सब पूरे चयन पर एक साथ किया जा सकता है।
- <!--i:layers--> **वीडियो को उसके बैकग्राउंड से अलग करें।** किसी वीडियो का विवरण खोलें या किसी भी एसेट पिकर में उसके कार्ड पर राइट-क्लिक करें और पारदर्शी विकल्प सेव करने के लिए **Remove background…** चुनें - असली अल्फ़ा वाला एनिमेटेड WebP या PNG। एक **Method** चुनें: **On-device model** व्यस्त दृश्य से विषय को काटता है, या **Colour key** समान रूप से रोशन, सपाट पृष्ठभूमि जैसे ग्रीन स्क्रीन या सादी दीवार को हटाता है, किनारे को ठीक करने के लिए **Tolerance**, **Softness** और **Spill removal** के साथ। कलर की को न किसी मॉडल डाउनलोड की ज़रूरत है न नेटवर्क की, इसलिए **Remove background** हर वीडियो पर उपलब्ध है और अक्सर साफ़-सुथरी फ़ुटेज पर बेहतर परिणाम देता है। एक **Resolution** नियंत्रण (360, 480, 720 या 1080p, स्रोत से कभी अधिक नहीं) विस्तार को एक छोटी, तेज़ फ़ाइल के लिए त्यागता है। यह आपके डिवाइस पर बैकग्राउंड जॉब के रूप में चलता है। तैयार कट-आउट मूल के साथ अपने ही एसेट के रूप में आता है और स्रोत वीडियो का Content Credential एक ingredient के रूप में साथ चलता है। (देखें [एक बार जनरेट, समान रूप से रेंडर](/info/ai-features.html) कि बैकग्राउंड हटाना एक साधारण संपादन क्यों रहता है।)
