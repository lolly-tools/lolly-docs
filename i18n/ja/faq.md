...
**ツールとブランドカタログは作成する必要があります。** Lolly はプラットフォームであり、あらかじめ完成されたテンプレート集ではありません。誰かがアセットカタログ（ロゴ、パレット、フォントを恒久的な ID として）を定義し、各出力タイプごとにマニフェストとテンプレートを書く必要があります。

**ガバナンスは git 上で動きます。** 「PR レビュー*が*モデレーションである」という考え方は、エンジニアにとってはエレガントですが、ほとんどのブランド・マーケティングチームにはなじみがありません。ブランドの意思決定を担う人々が git の中で暮らしていないなら、彼らをつなぐワークフローが必要になるでしょう — さもなければ IT部門が、静かに戦略的デザインパートナー兼、より広い組織のゲートキーパーになっていきます。これは、長期運用の本番環境では多くの場合むしろ好まれることです。
